...
function CtImageBox(props) {
  ...
  function changeMode() {
    if (original_image === null || lime_image === null)  {
      return(
          <Box>
            <Image maxWidth={{lg:"535px"}} maxHeight={{lg:"535px"}} minWidth={{sm:"350px", lg:"534px"}} src='https://i.ytimg.com/vi/mxQyBkNAZgU/hqdefault.jpg'></Image>
          </Box>
      )
    }
  ...
  return(
          <Box>
            <Image maxWidth={{lg:"535px"}} maxHeight={{lg:"535px"}} minWidth={{sm:"350px", lg:"534px"}} src='https://www.publicdomainpictures.net/pictures/280000/nahled/not-found-image-15383864787lu.jpg'></Image>
          </Box>
      )
    }
